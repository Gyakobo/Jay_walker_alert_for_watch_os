...
/home/itsrc/J2375_2016/src/asncode/dsrc/PositionConfidenceSet.java: 
...
/**
 * Class definition of the PositionConfidenceSet type of the dsrc module.
 */
public class PositionConfidenceSet extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 53;

  /**
   * mandatory field pos.
   */
  public j2375.dsrc.asncode.dsrc.PositionConfidence pos;

  /**
   * <BR> for both horizontal directions
   * mandatory field elevation.
   */
  public j2375.dsrc.asncode.dsrc.ElevationConfidence elevation;

  /**
   *  Constructs a newly allocated PositionConfidenceSet.
   */
  ...
  /**
   *  Gets the value of a component from this PositionConfidenceSet.
  ...
  /**
   *  Creates a newly allocated component value from this PositionConfidenceSet.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this PositionConfidenceSet.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.dsrc.PositionConfidence();
     case 1 :
       return new j2375.dsrc.asncode.dsrc.ElevationConfidence();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this PositionConfidenceSet.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this PositionConfidenceSet.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.pos = new j2375.dsrc.asncode.dsrc.PositionConfidence();
       return this.pos;
     case 1 :
       this.elevation = new j2375.dsrc.asncode.dsrc.ElevationConfidence();
       return this.elevation;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
