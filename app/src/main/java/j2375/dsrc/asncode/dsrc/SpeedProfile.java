...
/home/itsrc/J2375_2016/src/asncode/dsrc/SpeedProfile.java: 
...
/**
 * Class definition of the SpeedProfile type of the dsrc module.
 */
public class SpeedProfile extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 197;

  /**
   * <BR> Composed of set of measured average speeds
   * mandatory field speedReports.
   */
  public j2375.dsrc.asncode.dsrc.SpeedProfileMeasurementList speedReports;

  /**
   *  Constructs a newly allocated SpeedProfile.
   */
  public SpeedProfile ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this SpeedProfile.
  ...
  /**
   *  Creates a newly allocated component value from this SpeedProfile.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SpeedProfile.
  ...
  /**
   *  Creates and sets a newly allocated component value from this SpeedProfile.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SpeedProfile.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.speedReports = new j2375.dsrc.asncode.dsrc.SpeedProfileMeasurementList();
       return this.speedReports;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the SpeedProfile.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SpeedProfile.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SpeedProfile.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
