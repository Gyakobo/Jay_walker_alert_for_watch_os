...
/home/itsrc/J2375_2016/src/asncode/dsrc/PrivilegedEvents.java: 
...
/**
 * Class definition of the PrivilegedEvents type of the dsrc module.
 */
public class PrivilegedEvents extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 70;
  ...
  /**
   * <BR> The active event list
   * mandatory field event.
   */
  public j2375.dsrc.asncode.dsrc.PrivilegedEventFlags event;

  /**
   *  Constructs a newly allocated PrivilegedEvents.
   */
  ...
  /**
   *  Gets the value of a component from this PrivilegedEvents.
  ...
  /**
   *  Creates a newly allocated component value from this PrivilegedEvents.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this PrivilegedEvents.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       return new j2375.dsrc.asncode.dsrc.PrivilegedEventFlags();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this PrivilegedEvents.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this PrivilegedEvents.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 0 :
       ...
       return this.sspRights;
     case 1 :
       this.event = new j2375.dsrc.asncode.dsrc.PrivilegedEventFlags();
       return this.event;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the PrivilegedEvents.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the PrivilegedEvents.
  ...
  /**
   *  Creates and sets a newly allocated group value of the PrivilegedEvents.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
