...
/home/itsrc/J2375_2016/src/asncode/dsrc/RTCMcorrections.java: 
...
/**
 * Class definition of the RTCMcorrections type of the dsrc module.
 */
public class RTCMcorrections extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 173;
   ...
   * mandatory field rev.
   */
  public j2375.dsrc.asncode.dsrc.RTCM_Revision rev;

  /**
   * <BR> the specific edition of the standard
   * <BR> that is being sent
   * optional field timeStamp.
   */
  public j2375.dsrc.asncode.dsrc.MinuteOfTheYear timeStamp;

  /**
   * <BR> Observer position, if needed
   * optional field anchorPoint.
   */
  public j2375.dsrc.asncode.dsrc.FullPositionVector anchorPoint;

  /**
   * <BR> Precise ant position and noise data for a rover
   * optional field rtcmHeader.
   */
  public j2375.dsrc.asncode.dsrc.RTCMheader rtcmHeader;

  /**
   * <BR> one or more RTCM messages
   * mandatory field msgs.
   */
  public j2375.dsrc.asncode.dsrc.RTCMmessageList msgs;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.RTCMcorrections.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.RTCMcorrections.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated RTCMcorrections.
   */
  ...
  /**
   *  Gets the value of a component from this RTCMcorrections.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this RTCMcorrections.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RTCMcorrections.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       return new j2375.dsrc.asncode.dsrc.RTCM_Revision();
     case 2 :
  ...
  /**
   *  Creates and sets a newly allocated component value from this RTCMcorrections.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RTCMcorrections.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 0 :
       ...
       return this.msgCnt;
     case 1 :
       this.rev = new j2375.dsrc.asncode.dsrc.RTCM_Revision();
       return this.rev;
     case 2 :
       this.timeStamp = new j2375.dsrc.asncode.dsrc.MinuteOfTheYear();
       return this.timeStamp;
     case 3 :
       this.anchorPoint = new j2375.dsrc.asncode.dsrc.FullPositionVector();
       return this.anchorPoint;
     case 4 :
       this.rtcmHeader = new j2375.dsrc.asncode.dsrc.RTCMheader();
       return this.rtcmHeader;
     case 5 :
       this.msgs = new j2375.dsrc.asncode.dsrc.RTCMmessageList();
       return this.msgs;
     case 6 :
  ...
  /**
   *  Gets a group value from the RTCMcorrections.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the RTCMcorrections.
  ...
  /**
   *  Creates and sets a newly allocated group value of the RTCMcorrections.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
