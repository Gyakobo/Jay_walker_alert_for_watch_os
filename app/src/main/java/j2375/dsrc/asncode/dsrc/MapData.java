...
/home/itsrc/J2375_2016/src/asncode/dsrc/MapData.java: 
...
/**
 * Class definition of the MapData type of the dsrc module.
 */
public class MapData extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 140;
  ...
  /**
   * mandatory field msgIssueRevision.
   */
  public j2375.dsrc.asncode.dsrc.MsgCount msgIssueRevision;

  /**
   * optional field layerType.
   */
  public j2375.dsrc.asncode.dsrc.LayerType layerType;

  /**
   * optional field layerID.
   */
  public j2375.dsrc.asncode.dsrc.LayerID layerID;

  /**
   * optional field intersections.
   */
  public j2375.dsrc.asncode.dsrc.IntersectionGeometryList intersections;

  /**
   * <BR> All Intersection definitions 
   * optional field roadSegments.
   */
  public j2375.dsrc.asncode.dsrc.RoadSegmentList roadSegments;

  /**
   * <BR> All roadway descriptions
   * optional field dataParameters.
   */
  public j2375.dsrc.asncode.dsrc.DataParameters dataParameters;

  /**
   * <BR> Any meta data regarding the map contents
   * optional field restrictionList.
   */
  public j2375.dsrc.asncode.dsrc.RestrictionClassList restrictionList;

  /**
   * <BR> Any restriction ID tables which have  
   * <BR> established for these map entries 
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    public static class SEQUENCE extends fr.marben.asnsdk.japi.spe.SequenceValue
    {
       ...
       *   {@link j2375.dsrc.asncode.addgrpc.MapData_addGrpC j2375.dsrc.asncode.addgrpc.MapData_addGrpC}
       */
    ...
    {
          j2375.dsrc.asncode.dsrc.MapData.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.MapData.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated MapData.
   */
  public MapData ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this MapData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this MapData.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MapData.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       return new j2375.dsrc.asncode.dsrc.LayerType();
     case 3 :
       return new j2375.dsrc.asncode.dsrc.LayerID();
     case 4 :
  ...
  /**
   *  Creates and sets a newly allocated component value from this MapData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MapData.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       ...
       return this.msgIssueRevision;
     case 2 :
       this.layerType = new j2375.dsrc.asncode.dsrc.LayerType();
       return this.layerType;
     case 3 :
       this.layerID = new j2375.dsrc.asncode.dsrc.LayerID();
       return this.layerID;
     case 4 :
       this.intersections = new j2375.dsrc.asncode.dsrc.IntersectionGeometryList();
       return this.intersections;
     case 5 :
       this.roadSegments = new j2375.dsrc.asncode.dsrc.RoadSegmentList();
       return this.roadSegments;
     case 6 :
       this.dataParameters = new j2375.dsrc.asncode.dsrc.DataParameters();
       return this.dataParameters;
     case 7 :
       this.restrictionList = new j2375.dsrc.asncode.dsrc.RestrictionClassList();
       return this.restrictionList;
     case 8 :
  ...
  /**
   *  Gets a group value from the MapData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the MapData.
  ...
  /**
   *  Creates and sets a newly allocated group value of the MapData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
