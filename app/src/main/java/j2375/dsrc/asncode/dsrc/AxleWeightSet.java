...
/home/itsrc/J2375_2016/src/asncode/dsrc/AxleWeightSet.java: 
...
/**
 * Class definition of the AxleWeightSet type of the dsrc module.
 */
public class AxleWeightSet extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 38;

  /**
   * optional field location.
   */
  public j2375.dsrc.asncode.dsrc.AxleLocation location;

  /**
   * optional field weight.
   */
  public j2375.dsrc.asncode.dsrc.AxleWeight weight;

  /**
   *  Constructs a newly allocated AxleWeightSet.
   */
  ...
  /**
   *  Gets the value of a component from this AxleWeightSet.
  ...
  /**
   *  Creates a newly allocated component value from this AxleWeightSet.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this AxleWeightSet.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.dsrc.AxleLocation();
     case 1 :
       return new j2375.dsrc.asncode.dsrc.AxleWeight();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this AxleWeightSet.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this AxleWeightSet.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.location = new j2375.dsrc.asncode.dsrc.AxleLocation();
       return this.location;
     case 1 :
       this.weight = new j2375.dsrc.asncode.dsrc.AxleWeight();
       return this.weight;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the AxleWeightSet.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the AxleWeightSet.
  ...
  /**
   *  Creates and sets a newly allocated group value of the AxleWeightSet.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
