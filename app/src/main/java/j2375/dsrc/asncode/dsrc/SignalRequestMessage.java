...
/home/itsrc/J2375_2016/src/asncode/dsrc/SignalRequestMessage.java: 
...
/**
 * Class definition of the SignalRequestMessage type of the dsrc module.
 */
public class SignalRequestMessage extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 183;
  ...
  /**
   * optional field requests.
   */
  public j2375.dsrc.asncode.dsrc.SignalRequestList requests;

  /**
   * <BR> Request Data for one or more signalized 
   * <BR> intersections that support SRM dialogs
   * mandatory field requestor.
   */
  public j2375.dsrc.asncode.dsrc.RequestorDescription requestor;

  /**
   * <BR> Requesting Device and other User Data
   * <BR> contains vehicle ID (if from a vehicle)
   * <BR> as well as type data and current position
   * <BR> and may contain additional transit data
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.SignalRequestMessage.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.SignalRequestMessage.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated SignalRequestMessage.
   */
  ...
  /**
   *  Gets the value of a component from this SignalRequestMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this SignalRequestMessage.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalRequestMessage.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this SignalRequestMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalRequestMessage.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       ...
       return this.sequenceNumber;
     case 3 :
       this.requests = new j2375.dsrc.asncode.dsrc.SignalRequestList();
       return this.requests;
     case 4 :
       this.requestor = new j2375.dsrc.asncode.dsrc.RequestorDescription();
       return this.requestor;
     case 5 :
  ...
  /**
   *  Gets a group value from the SignalRequestMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SignalRequestMessage.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SignalRequestMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
