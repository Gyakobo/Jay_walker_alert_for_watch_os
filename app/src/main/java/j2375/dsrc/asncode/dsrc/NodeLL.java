...
/home/itsrc/J2375_2016/src/asncode/dsrc/NodeLL.java: 
...
/**
 * <BR> a lane path computed by translating 
 * <BR> the data defined by another lane
 * Class definition of the NodeLL type of the dsrc module.
 */
public class NodeLL extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 98;

  /**
   * mandatory field delta.
   */
  public j2375.dsrc.asncode.dsrc.NodeOffsetPointLL delta;

  /**
   * <BR> A choice of which Lat,Lon offset value to use  
   * <BR> this includes various delta values as well a regional choices
   * optional field attributes.
   */
  public j2375.dsrc.asncode.dsrc.NodeAttributeSetLL attributes;

  /**
   *  Constructs a newly allocated NodeLL.
   */
  public NodeLL ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this NodeLL.
  ...
  /**
   *  Creates a newly allocated component value from this NodeLL.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this NodeLL.
  ...
  /**
   *  Creates and sets a newly allocated component value from this NodeLL.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this NodeLL.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.delta = new j2375.dsrc.asncode.dsrc.NodeOffsetPointLL();
       return this.delta;
     case 1 :
       this.attributes = new j2375.dsrc.asncode.dsrc.NodeAttributeSetLL();
       return this.attributes;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the NodeLL.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the NodeLL.
  ...
  /**
   *  Creates and sets a newly allocated group value of the NodeLL.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
