...
/home/itsrc/J2375_2016/src/asncode/dsrc/Position3D.java: 
...
/**
 * <BR> true if this unit can rotate about the pivot connection point
 * Class definition of the Position3D type of the dsrc module.
 */
public class Position3D extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 46;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    public static class SEQUENCE extends fr.marben.asnsdk.japi.spe.SequenceValue
    {
       ...
       *   {@link j2375.dsrc.asncode.addgrpb.Position3D_addGrpB j2375.dsrc.asncode.addgrpb.Position3D_addGrpB}
       *   {@link j2375.dsrc.asncode.addgrpc.Position3D_addGrpC j2375.dsrc.asncode.addgrpc.Position3D_addGrpC}
       */
    ...
    {
          j2375.dsrc.asncode.dsrc.Position3D.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.Position3D.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated Position3D.
   */
  public Position3D ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this Position3D.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this Position3D.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Position3D.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this Position3D.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Position3D.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the Position3D.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the Position3D.
  ...
  /**
   *  Creates and sets a newly allocated group value of the Position3D.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
