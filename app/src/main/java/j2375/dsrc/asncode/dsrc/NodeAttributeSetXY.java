...
/home/itsrc/J2375_2016/src/asncode/dsrc/NodeAttributeSetXY.java: 
...
/**
 * Class definition of the NodeAttributeSetXY type of the dsrc module.
 */
public class NodeAttributeSetXY extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 84;

  /**
   * optional field localNode.
   */
  public j2375.dsrc.asncode.dsrc.NodeAttributeXYList localNode;

  /**
   * <BR> Attribute states which pertain to this node point
   * optional field disabled.
   */
  public j2375.dsrc.asncode.dsrc.SegmentAttributeXYList disabled;

  /**
   * <BR> Attribute states which are disabled at this node point
   * optional field enabled.
   */
  public j2375.dsrc.asncode.dsrc.SegmentAttributeXYList enabled;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.NodeAttributeSetXY.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.NodeAttributeSetXY.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated NodeAttributeSetXY.
   */
  ...
  /**
   *  Gets the value of a component from this NodeAttributeSetXY.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this NodeAttributeSetXY.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this NodeAttributeSetXY.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this NodeAttributeSetXY.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this NodeAttributeSetXY.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.localNode = new j2375.dsrc.asncode.dsrc.NodeAttributeXYList();
       return this.localNode;
     case 1 :
       this.disabled = new j2375.dsrc.asncode.dsrc.SegmentAttributeXYList();
       return this.disabled;
     case 2 :
       this.enabled = new j2375.dsrc.asncode.dsrc.SegmentAttributeXYList();
       return this.enabled;
     case 3 :
  ...
  /**
   *  Gets a group value from the NodeAttributeSetXY.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the NodeAttributeSetXY.
  ...
  /**
   *  Creates and sets a newly allocated group value of the NodeAttributeSetXY.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
