...
/home/itsrc/J2375_2016/src/asncode/dsrc/CommonSafetyRequest.java: 
...
/**
 * Class definition of the CommonSafetyRequest type of the dsrc module.
 */
public class CommonSafetyRequest extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 48;
  ...
  /**
   * <BR> targeted remote device              
   * mandatory field requests.
   */
  public j2375.dsrc.asncode.dsrc.RequestedItemList requests;

  /**
   * <BR> Note: Above no longer uses the same request as probe management
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.CommonSafetyRequest.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.CommonSafetyRequest.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated CommonSafetyRequest.
   */
  ...
  /**
   *  Gets the value of a component from this CommonSafetyRequest.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this CommonSafetyRequest.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this CommonSafetyRequest.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this CommonSafetyRequest.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this CommonSafetyRequest.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       ...
       return this.id;
     case 3 :
       this.requests = new j2375.dsrc.asncode.dsrc.RequestedItemList();
       return this.requests;
     case 4 :
  ...
  /**
   *  Gets a group value from the CommonSafetyRequest.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the CommonSafetyRequest.
  ...
  /**
   *  Creates and sets a newly allocated group value of the CommonSafetyRequest.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
