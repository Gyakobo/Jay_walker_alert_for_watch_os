...
/home/itsrc/J2375_2016/src/asncode/dsrc/SPAT.java: 
...
/**
 * Class definition of the SPAT type of the dsrc module.
 */
public class SPAT extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 178;
  ...
  /**
   * <BR> human readable name for this collection 
   * <BR> to be used only in debug mode
   * mandatory field intersections.
   */
  public j2375.dsrc.asncode.dsrc.IntersectionStateList intersections;

  /**
   * <BR> sets of SPAT data (one per intersection)  
   * <BR> If PrioritizationResponse data is required, it is found 
   * <BR> in the RegionalSPAT entry below
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.SPAT.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.SPAT.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated SPAT.
   */
  public SPAT ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this SPAT.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this SPAT.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SPAT.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this SPAT.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SPAT.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       ...
       return this.name;
     case 2 :
       this.intersections = new j2375.dsrc.asncode.dsrc.IntersectionStateList();
       return this.intersections;
     case 3 :
  ...
  /**
   *  Gets a group value from the SPAT.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SPAT.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SPAT.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
