...
/home/itsrc/J2375_2016/src/asncode/dsrc/RTCMPackage.java: 
...
/**
 * Class definition of the RTCMPackage type of the dsrc module.
 */
public class RTCMPackage extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 170;

  /**
   * <BR> precise antenna position and noise data for a rover
  ...
  /**
   *  Constructs a newly allocated RTCMPackage.
   */
  public RTCMPackage ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this RTCMPackage.
  ...
  /**
   *  Creates a newly allocated component value from this RTCMPackage.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RTCMPackage.
  ...
  /**
   *  Creates and sets a newly allocated component value from this RTCMPackage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RTCMPackage.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the RTCMPackage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the RTCMPackage.
  ...
  /**
   *  Creates and sets a newly allocated group value of the RTCMPackage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
