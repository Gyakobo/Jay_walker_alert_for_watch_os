...
/home/itsrc/J2375_2016/src/asncode/dsrc/Node_XY_26b.java: 
...
/**
 * Class definition of the Node_XY_26b type of the dsrc module.
 */
public class Node_XY_26b extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 19;

  /**
   * mandatory field x.
   */
  public j2375.dsrc.asncode.dsrc.Offset_B13 x;

  /**
   * mandatory field y.
   */
  public j2375.dsrc.asncode.dsrc.Offset_B13 y;

  /**
   *  Constructs a newly allocated Node_XY_26b.
   */
  public Node_XY_26b ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this Node_XY_26b.
  ...
  /**
   *  Creates a newly allocated component value from this Node_XY_26b.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_XY_26b.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.dsrc.Offset_B13();
     case 1 :
       return new j2375.dsrc.asncode.dsrc.Offset_B13();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this Node_XY_26b.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_XY_26b.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.x = new j2375.dsrc.asncode.dsrc.Offset_B13();
       return this.x;
     case 1 :
       this.y = new j2375.dsrc.asncode.dsrc.Offset_B13();
       return this.y;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
