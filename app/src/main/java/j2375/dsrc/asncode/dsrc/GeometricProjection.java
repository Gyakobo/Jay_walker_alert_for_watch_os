...
/home/itsrc/J2375_2016/src/asncode/dsrc/GeometricProjection.java: 
...
/**
 * Class definition of the GeometricProjection type of the dsrc module.
 */
public class GeometricProjection extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 109;
  ...
  /**
   * <BR> used when a width is needed
   * mandatory field circle.
   */
  public j2375.dsrc.asncode.dsrc.Circle circle;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.GeometricProjection.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.GeometricProjection.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated GeometricProjection.
   */
  ...
  /**
   *  Gets the value of a component from this GeometricProjection.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this GeometricProjection.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this GeometricProjection.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this GeometricProjection.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this GeometricProjection.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       ...
       return this.laneWidth;
     case 3 :
       this.circle = new j2375.dsrc.asncode.dsrc.Circle();
       return this.circle;
     case 4 :
  ...
  /**
   *  Gets a group value from the GeometricProjection.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the GeometricProjection.
  ...
  /**
   *  Creates and sets a newly allocated group value of the GeometricProjection.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
