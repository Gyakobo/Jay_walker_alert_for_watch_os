...
/home/itsrc/J2375_2016/src/asncode/dsrc/Node_LL_28B.java: 
...
/**
 * Class definition of the Node_LL_28B type of the dsrc module.
 */
public class Node_LL_28B extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 101;

  /**
   * <BR> ranges of +- 00008191 degrees
   * <BR> ranges of +- 90571389 meters at the equator
   * mandatory field lon.
   */
  public j2375.dsrc.asncode.dsrc.OffsetLL_B14 lon;

  /**
   * mandatory field lat.
   */
  public j2375.dsrc.asncode.dsrc.OffsetLL_B14 lat;

  /**
   *  Constructs a newly allocated Node_LL_28B.
   */
  public Node_LL_28B ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this Node_LL_28B.
  ...
  /**
   *  Creates a newly allocated component value from this Node_LL_28B.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LL_28B.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.dsrc.OffsetLL_B14();
     case 1 :
       return new j2375.dsrc.asncode.dsrc.OffsetLL_B14();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this Node_LL_28B.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LL_28B.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.lon = new j2375.dsrc.asncode.dsrc.OffsetLL_B14();
       return this.lon;
     case 1 :
       this.lat = new j2375.dsrc.asncode.dsrc.OffsetLL_B14();
       return this.lat;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
