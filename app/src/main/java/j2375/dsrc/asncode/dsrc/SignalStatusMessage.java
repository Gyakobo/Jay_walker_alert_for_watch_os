...
/home/itsrc/J2375_2016/src/asncode/dsrc/SignalStatusMessage.java: 
...
/**
 * Class definition of the SignalStatusMessage type of the dsrc module.
 */
public class SignalStatusMessage extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 189;
  ...
  /**
   * <BR> Status Data for one of more signalized intersections
   * mandatory field status.
   */
  public j2375.dsrc.asncode.dsrc.SignalStatusList status;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.SignalStatusMessage.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.SignalStatusMessage.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated SignalStatusMessage.
   */
  ...
  /**
   *  Gets the value of a component from this SignalStatusMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this SignalStatusMessage.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalStatusMessage.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this SignalStatusMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalStatusMessage.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       ...
       return this.sequenceNumber;
     case 3 :
       this.status = new j2375.dsrc.asncode.dsrc.SignalStatusList();
       return this.status;
     case 4 :
  ...
  /**
   *  Gets a group value from the SignalStatusMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SignalStatusMessage.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SignalStatusMessage.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
