...
/home/itsrc/J2375_2016/src/asncode/dsrc/Node_LLmD_64b.java: 
...
/**
 * Class definition of the Node_LLmD_64b type of the dsrc module.
 */
public class Node_LLmD_64b extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 22;

  /**
   * mandatory field lon.
   */
  public j2375.dsrc.asncode.dsrc.Longitude lon;
  ...
  /**
   *  Constructs a newly allocated Node_LLmD_64b.
   */
  ...
  /**
   *  Gets the value of a component from this Node_LLmD_64b.
  ...
  /**
   *  Creates a newly allocated component value from this Node_LLmD_64b.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LLmD_64b.
  ...
  /**
   *  Creates and sets a newly allocated component value from this Node_LLmD_64b.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LLmD_64b.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.lon = new j2375.dsrc.asncode.dsrc.Longitude();
       return this.lon;
     case 1 :
