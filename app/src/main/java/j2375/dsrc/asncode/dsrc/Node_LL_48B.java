...
/home/itsrc/J2375_2016/src/asncode/dsrc/Node_LL_48B.java: 
...
/**
 * Class definition of the Node_LL_48B type of the dsrc module.
 */
public class Node_LL_48B extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 105;

  /**
   * <BR> ranges of +- 08388607 degrees
   * <BR> ranges of +- 92756481 Kmeters at the equator
   * mandatory field lon.
   */
  public j2375.dsrc.asncode.dsrc.OffsetLL_B24 lon;

  /**
   * mandatory field lat.
   */
  public j2375.dsrc.asncode.dsrc.OffsetLL_B24 lat;

  /**
   *  Constructs a newly allocated Node_LL_48B.
   */
  public Node_LL_48B ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this Node_LL_48B.
  ...
  /**
   *  Creates a newly allocated component value from this Node_LL_48B.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LL_48B.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.dsrc.OffsetLL_B24();
     case 1 :
       return new j2375.dsrc.asncode.dsrc.OffsetLL_B24();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this Node_LL_48B.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LL_48B.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.lon = new j2375.dsrc.asncode.dsrc.OffsetLL_B24();
       return this.lon;
     case 1 :
       this.lat = new j2375.dsrc.asncode.dsrc.OffsetLL_B24();
       return this.lat;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
