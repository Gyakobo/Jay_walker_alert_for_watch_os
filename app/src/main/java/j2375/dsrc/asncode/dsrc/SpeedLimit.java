...
/home/itsrc/J2375_2016/src/asncode/dsrc/SpeedLimit.java: 
...
/**
 * Class definition of the SpeedLimit type of the dsrc module.
 */
public class SpeedLimit extends fr.marben.asnsdk.japi.spe.SequenceOfValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 196;
  ...
  /**
   *  Constructs a newly allocated SpeedLimit.
   */
  public SpeedLimit ()
  {
    super();
  ...
  /**
   *  Constructs a newly allocated SpeedLimit with the given list.
   *  @param list the list used to initialize this SpeedLimit.
   */
  public SpeedLimit (java.util.List list)
  {
    super(list);
  };
   ...
   *  This method is only for ASNSDK internal use. 
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SpeedLimit.
  ...
  {
        j2375.dsrc.asncode.dsrc.SpeedLimit.SEQUENCE value = new j2375.dsrc.asncode.dsrc.SpeedLimit.SEQUENCE();
