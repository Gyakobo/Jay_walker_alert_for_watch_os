...
/home/itsrc/J2375_2016/src/asncode/dsrc/ExitService.java: 
...
/**
 * Class definition of the ExitService type of the dsrc module.
 */
public class ExitService extends fr.marben.asnsdk.japi.spe.SequenceOfValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 77;
  ...
  /**
   *  Constructs a newly allocated ExitService.
   */
  public ExitService ()
  {
    super();
  ...
  /**
   *  Constructs a newly allocated ExitService with the given list.
   *  @param list the list used to initialize this ExitService.
   */
  public ExitService (java.util.List list)
  {
    super(list);
  };
   ...
   *  This method is only for ASNSDK internal use. 
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ExitService.
  ...
  {
        j2375.dsrc.asncode.dsrc.ExitService.SEQUENCE value = new j2375.dsrc.asncode.dsrc.ExitService.SEQUENCE();
