...
/home/itsrc/J2375_2016/src/asncode/dsrc/ProbeVehicleData.java: 
...
/**
 * Class definition of the ProbeVehicleData type of the dsrc module.
 */
public class ProbeVehicleData extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 162;
  ...
  /**
   * optional field segNum.
   */
  public j2375.dsrc.asncode.dsrc.ProbeSegmentNumber segNum;

  /**
   * <BR> a short term Ident value
   * <BR> not used when ident is used
   * optional field probeID.
   */
  public j2375.dsrc.asncode.dsrc.VehicleIdent probeID;

  /**
   * <BR> identity data for selected 
   * <BR> types of vehicles    
   * mandatory field startVector.
   */
  public j2375.dsrc.asncode.dsrc.FullPositionVector startVector;

  /**
   * <BR> the space and time of 
   * <BR> transmission to the RSU
   * mandatory field vehicleType.
   */
  public j2375.dsrc.asncode.dsrc.VehicleClassification vehicleType;

  /**
   * <BR> type of vehicle, 
   * mandatory field snapshots.
   */
  public Snapshots snapshots;

  /**
   * <BR> a seq of name-value pairs 
   * <BR> along with the space and time 
   * <BR> of the first measurement set
   * optional field regional.
   */
  public Regional regional;

  /**
   * class definition of the snapshots field.
   */
  public static class Snapshots extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    /**
     *  Constructs a newly allocated Snapshots.
     */
    public Snapshots ()
    {
      super();
    ...
    /**
     *  Constructs a newly allocated Snapshots with the given list.
     *  @param list the list used to initialize this Snapshots.
     */
    public Snapshots (java.util.List list)
    {
      super(list);
    };
     ...
     *  @param field the named type of this Snapshots.
    ...
    {
          j2375.dsrc.asncode.dsrc.Snapshot value = new j2375.dsrc.asncode.dsrc.Snapshot();
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    public fr.marben.asnsdk.japi.vi.IValue asnAddNewSetSeqOfValue(
                          ...
                          fr.marben.asnsdk.japi.vi.ISetSeqOfNamedType field)
    {
          j2375.dsrc.asncode.dsrc.ProbeVehicleData.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.ProbeVehicleData.Regional.SEQUENCE();
          this.valueList.add(value);
          return value;
    }
  }
  ...
  /**
   *  Constructs a newly allocated ProbeVehicleData.
   */
  ...
  /**
   *  Gets the value of a component from this ProbeVehicleData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this ProbeVehicleData.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ProbeVehicleData.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       return new j2375.dsrc.asncode.dsrc.ProbeSegmentNumber();
     case 2 :
  ...
  /**
   *  Creates and sets a newly allocated component value from this ProbeVehicleData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ProbeVehicleData.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 0 :
       ...
       return this.timeStamp;
     case 1 :
       this.segNum = new j2375.dsrc.asncode.dsrc.ProbeSegmentNumber();
       return this.segNum;
     case 2 :
       this.probeID = new j2375.dsrc.asncode.dsrc.VehicleIdent();
       return this.probeID;
     case 3 :
       this.startVector = new j2375.dsrc.asncode.dsrc.FullPositionVector();
       return this.startVector;
     case 4 :
       this.vehicleType = new j2375.dsrc.asncode.dsrc.VehicleClassification();
       return this.vehicleType;
     case 5 :
  ...
  /**
   *  Gets a group value from the ProbeVehicleData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the ProbeVehicleData.
  ...
  /**
   *  Creates and sets a newly allocated group value of the ProbeVehicleData.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
