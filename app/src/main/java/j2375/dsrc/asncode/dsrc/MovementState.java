...
/home/itsrc/J2375_2016/src/asncode/dsrc/MovementState.java: 
...
/**
 * Class definition of the MovementState type of the dsrc module.
 */
public class MovementState extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 129;

  /**
   * optional field movementName.
   */
  public j2375.dsrc.asncode.dsrc.DescriptiveName movementName;

  /**
   * <BR> uniquely defines movement by name   
  ...
  /**
   * <BR> the group id is used to map to lists 
   * <BR> of lanes (and their descriptions) 
   * <BR> which this MovementState data applies to 
   * <BR> see comments in the Remarks for usage details 
   * mandatory field state_time_speed.
   */
  public j2375.dsrc.asncode.dsrc.MovementEventList state_time_speed;

  /**
   * <BR> Consisting of sets of movement data with:
   * <BR> a)  SignalPhaseState
   * <BR> b)  TimeChangeDetails,  and 
   * <BR> c)  AdvisorySpeeds      (optional )
   * <BR> Note one or more of the movement events may be for 
   * <BR> a future time and that this allows conveying multiple 
   * <BR> predictive phase and movement timing for various uses
   * <BR> for the current signal group
   * optional field maneuverAssistList.
   */
  public j2375.dsrc.asncode.dsrc.ManeuverAssistList maneuverAssistList;

  /**
   * <BR> This information may also be placed in the 
   * <BR> IntersectionState when common information applies to
   * <BR> different lanes in the same way
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.MovementState.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.MovementState.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated MovementState.
   */
  ...
  /**
   *  Gets the value of a component from this MovementState.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this MovementState.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MovementState.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this MovementState.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MovementState.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.movementName = new j2375.dsrc.asncode.dsrc.DescriptiveName();
       return this.movementName;
     case 1 :
       this.signalGroup = new j2375.dsrc.asncode.dsrc.SignalGroupID();
       return this.signalGroup;
     case 2 :
       this.state_time_speed = new j2375.dsrc.asncode.dsrc.MovementEventList();
       return this.state_time_speed;
     case 3 :
  ...
  /**
   *  Gets a group value from the MovementState.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the MovementState.
  ...
  /**
   *  Creates and sets a newly allocated group value of the MovementState.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
