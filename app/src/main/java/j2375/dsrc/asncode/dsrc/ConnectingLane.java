...
/home/itsrc/J2375_2016/src/asncode/dsrc/ConnectingLane.java: 
...
/**
 * Class definition of the ConnectingLane type of the dsrc module.
 */
public class ConnectingLane extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 54;

  /**
   * mandatory field lane.
   */
  public j2375.dsrc.asncode.dsrc.LaneID lane;

  /**
   * <BR> Index of the connecting lane
   * optional field maneuver.
   */
  public j2375.dsrc.asncode.dsrc.AllowedManeuvers maneuver;

  /**
   *  Constructs a newly allocated ConnectingLane.
   */
  ...
  /**
   *  Gets the value of a component from this ConnectingLane.
  ...
  /**
   *  Creates a newly allocated component value from this ConnectingLane.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ConnectingLane.
  ...
  /**
   *  Creates and sets a newly allocated component value from this ConnectingLane.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ConnectingLane.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.lane = new j2375.dsrc.asncode.dsrc.LaneID();
       return this.lane;
     case 1 :
       this.maneuver = new j2375.dsrc.asncode.dsrc.AllowedManeuvers();
       return this.maneuver;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
