...
/home/itsrc/J2375_2016/src/asncode/dsrc/WeatherProbe.java: 
...
/**
 * <BR> offset which follows is of a
 * <BR> regional definition type
 * Class definition of the WeatherProbe type of the dsrc module.
 */
public class WeatherProbe extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 202;
  ...
  /**
   * optional field airPressure.
   */
  public j2375.dsrc.asncode.dsrc.AmbientAirPressure airPressure;

  /**
   * optional field rainRates.
   */
  public j2375.dsrc.asncode.dsrc.WiperSet rainRates;

  /**
   *  Constructs a newly allocated WeatherProbe.
   */
  public WeatherProbe ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this WeatherProbe.
  ...
  /**
   *  Creates a newly allocated component value from this WeatherProbe.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this WeatherProbe.
  ...
  /**
   *  Creates and sets a newly allocated component value from this WeatherProbe.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this WeatherProbe.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 0 :
       ...
       return this.airTemp;
     case 1 :
       this.airPressure = new j2375.dsrc.asncode.dsrc.AmbientAirPressure();
       return this.airPressure;
     case 2 :
       this.rainRates = new j2375.dsrc.asncode.dsrc.WiperSet();
       return this.rainRates;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the WeatherProbe.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the WeatherProbe.
  ...
  /**
   *  Creates and sets a newly allocated group value of the WeatherProbe.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
