...
/home/itsrc/J2375_2016/src/asncode/dsrc/SignalStatus.java: 
...
/**
 * Class definition of the SignalStatus type of the dsrc module.
 */
public class SignalStatus extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 185;
  ...
  /**
   * <BR> changed whenever the below contents have change
   * mandatory field id.
   */
  public j2375.dsrc.asncode.dsrc.IntersectionReferenceID id;

  /**
   * <BR> this provides a unique mapping to the 
   * <BR> intersection map in question
   * <BR> which provides complete location 
   * <BR> and approach/movement/lane data
   * <BR> as well as zones for priority/preemption
   * mandatory field sigStatus.
   */
  public j2375.dsrc.asncode.dsrc.SignalStatusPackageList sigStatus;

  /**
   * <BR> a list of detailed status containing all
   * <BR> priority or preemption state data, both
   * <BR> active and pending, and who requested it
   * <BR> requests which are denied are also listed
   * <BR> here for a short period of time
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.SignalStatus.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.SignalStatus.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated SignalStatus.
   */
  public SignalStatus ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this SignalStatus.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this SignalStatus.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalStatus.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this SignalStatus.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalStatus.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       ...
       return this.id;
     case 2 :
       this.sigStatus = new j2375.dsrc.asncode.dsrc.SignalStatusPackageList();
       return this.sigStatus;
     case 3 :
  ...
  /**
   *  Gets a group value from the SignalStatus.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SignalStatus.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SignalStatus.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
