...
/home/itsrc/J2375_2016/src/asncode/dsrc/TravelerInformation.java: 
...
/**
 * Class definition of the TravelerInformation type of the dsrc module.
 */
public class TravelerInformation extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 224;
  ...
  /**
   * optional field packetID.
   */
  public j2375.dsrc.asncode.dsrc.UniqueMSGID packetID;

  /**
   * optional field urlB.
   */
  public j2375.dsrc.asncode.dsrc.URL_Base urlB;

  /**
   * <BR> A set of one or more self contained 
   * <BR> traveler information messages (frames)
   * mandatory field dataFrames.
   */
  public j2375.dsrc.asncode.dsrc.TravelerDataFrameList dataFrames;
  ...
  public static class Regional extends fr.marben.asnsdk.japi.spe.SequenceOfValue
  {
    ...
    {
          j2375.dsrc.asncode.dsrc.TravelerInformation.Regional.SEQUENCE value = new j2375.dsrc.asncode.dsrc.TravelerInformation.Regional.SEQUENCE();
  ...
  /**
   *  Constructs a newly allocated TravelerInformation.
   */
  ...
  /**
   *  Gets the value of a component from this TravelerInformation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this TravelerInformation.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this TravelerInformation.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 2 :
       return new j2375.dsrc.asncode.dsrc.UniqueMSGID();
     case 3 :
       return new j2375.dsrc.asncode.dsrc.URL_Base();
     case 4 :
  ...
  /**
   *  Creates and sets a newly allocated component value from this TravelerInformation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this TravelerInformation.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     case 1 :
       ...
       return this.timeStamp;
     case 2 :
       this.packetID = new j2375.dsrc.asncode.dsrc.UniqueMSGID();
       return this.packetID;
     case 3 :
       this.urlB = new j2375.dsrc.asncode.dsrc.URL_Base();
       return this.urlB;
     case 4 :
       this.dataFrames = new j2375.dsrc.asncode.dsrc.TravelerDataFrameList();
       return this.dataFrames;
     case 5 :
  ...
  /**
   *  Gets a group value from the TravelerInformation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the TravelerInformation.
  ...
  /**
   *  Creates and sets a newly allocated group value of the TravelerInformation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
