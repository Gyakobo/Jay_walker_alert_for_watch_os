...
/home/itsrc/J2375_2016/src/asncode/dsrc/NodeAttributeXY.java: 
...
/**
 * Class definition of the NodeAttributeXY type of the dsrc module.
 */
public class NodeAttributeXY extends fr.marben.asnsdk.japi.spe.ExtEnumeratedValue
{
  /**
  ...
  /**
   *  Constructs a newly allocated NodeAttributeXY.
   */
  ...
  /**
   *  Constructs a newly allocated NodeAttributeXY that represents the primitive int argument.
   *  @param value the value to be represented by this NodeAttributeXY.
   */
  public NodeAttributeXY (int value)
  {
    super(value);
  };

  /**
   *  Constructs a newly allocated NodeAttributeXY that represents the unknownExt argument.
   *  @param unknownExt the unknown extension value to be represented by this NodeAttributeXY.
   */
  public NodeAttributeXY (fr.marben.asnsdk.japi.UnknownExtensionValue unknownExt)
  {
    super(unknownExt);
  };
}
