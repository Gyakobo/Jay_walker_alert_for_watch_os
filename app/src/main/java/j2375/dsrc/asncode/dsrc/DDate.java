...
/home/itsrc/J2375_2016/src/asncode/dsrc/DDate.java: 
...
/**
 * Class definition of the DDate type of the dsrc module.
 */
public class DDate extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 60;
  ...
  /**
   *  Constructs a newly allocated DDate.
   */
  public DDate ()
  {
    super();
  ...
  /**
   *  Gets the value of a component from this DDate.
  ...
  /**
   *  Creates a newly allocated component value from this DDate.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this DDate.
  ...
  /**
   *  Creates and sets a newly allocated component value from this DDate.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this DDate.
   *  @return a value from a class implementing the IValue interface.
