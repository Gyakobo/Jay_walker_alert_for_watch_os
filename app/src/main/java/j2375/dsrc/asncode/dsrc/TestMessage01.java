...
/home/itsrc/J2375_2016/src/asncode/dsrc/TestMessage01.java: 
...
/**
 * Class definition of the TestMessage01 type of the dsrc module.
 */
public class TestMessage01 extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 204;
  ...
  /**
   *  Constructs a newly allocated TestMessage01.
   */
  ...
  /**
   *  Gets the value of a component from this TestMessage01.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this TestMessage01.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this TestMessage01.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this TestMessage01.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this TestMessage01.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the TestMessage01.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the TestMessage01.
  ...
  /**
   *  Creates and sets a newly allocated group value of the TestMessage01.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
