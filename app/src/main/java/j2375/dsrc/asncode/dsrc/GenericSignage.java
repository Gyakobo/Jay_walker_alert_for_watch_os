...
/home/itsrc/J2375_2016/src/asncode/dsrc/GenericSignage.java: 
...
/**
 * Class definition of the GenericSignage type of the dsrc module.
 */
public class GenericSignage extends fr.marben.asnsdk.japi.spe.SequenceOfValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 92;
  ...
  /**
   *  Constructs a newly allocated GenericSignage.
   */
  ...
  /**
   *  Constructs a newly allocated GenericSignage with the given list.
   *  @param list the list used to initialize this GenericSignage.
   */
  public GenericSignage (java.util.List list)
  {
    super(list);
  };
   ...
   *  This method is only for ASNSDK internal use. 
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this GenericSignage.
  ...
  {
        j2375.dsrc.asncode.dsrc.GenericSignage.SEQUENCE value = new j2375.dsrc.asncode.dsrc.GenericSignage.SEQUENCE();
