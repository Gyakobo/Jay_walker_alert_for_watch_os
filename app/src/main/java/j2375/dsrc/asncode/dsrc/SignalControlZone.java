...
/home/itsrc/J2375_2016/src/asncode/dsrc/SignalControlZone.java: 
...
/**
 * Class definition of the SignalControlZone type of the dsrc module.
 */
public class SignalControlZone extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 125;

  /**
   * mandatory field zone.
   */
  public Zone zone;

  /**
   * class definition of the zone field.
   */
  public static class Zone extends fr.marben.asnsdk.japi.spe.SequenceValue
  {
    /**
    ...
    /**
     *  Constructs a newly allocated Zone.
     */
    public Zone ()
    {
      super();
    ...
    /**
     *  Gets the value of a component from this Zone.
    ...
    /**
     *  Creates a newly allocated component value from this Zone.
     *  this value is created for temporary use to solve atNotations
     *  This method is only for ASNSDK internal use.
     *  @param context a fr.marben.asnsdk.japi.Context.
     *  @param field the named type of this Zone.
    ...
    /**
     *  Creates and sets a newly allocated component value from this Zone.
     *  This method is only for ASNSDK internal use.
     *  @param context a fr.marben.asnsdk.japi.Context.
     *  @param field the named type of this Zone.
     *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Constructs a newly allocated SignalControlZone.
   */
  ...
  /**
   *  Gets the value of a component from this SignalControlZone.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type identifier of the component.
   *  @return the value identified by the named type.
  ...
  /**
   *  Creates a newly allocated component value from this SignalControlZone.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalControlZone.
   *  @return a value from a class implementing the IValue interface.
   */
   public fr.marben.asnsdk.japi.vi.IValue asnSetNewTmpSetSeqValue(
                           fr.marben.asnsdk.japi.Context context,
  ...
  /**
   *  Creates and sets a newly allocated component value from this SignalControlZone.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalControlZone.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the SignalControlZone.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SignalControlZone.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SignalControlZone.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
