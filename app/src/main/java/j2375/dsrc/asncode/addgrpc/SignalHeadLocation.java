...
/home/itsrc/J2375_2016/src/asncode/addgrpc/SignalHeadLocation.java: 
...
/**
 * Class definition of the SignalHeadLocation type of the addgrpc module.
 */
public class SignalHeadLocation extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 28;

  /**
   * mandatory field node.
   */
  public j2375.dsrc.asncode.dsrc.NodeOffsetPointXY node;

  /**
   * <BR> the location
   * mandatory field signalGroupID.
   */
  public j2375.dsrc.asncode.dsrc.SignalGroupID signalGroupID;

  /**
   *  Constructs a newly allocated SignalHeadLocation.
   */
  ...
  /**
   *  Gets the value of a component from this SignalHeadLocation.
  ...
  /**
   *  Creates a newly allocated component value from this SignalHeadLocation.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalHeadLocation.
  ...
  /**
   *  Creates and sets a newly allocated component value from this SignalHeadLocation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this SignalHeadLocation.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.node = new j2375.dsrc.asncode.dsrc.NodeOffsetPointXY();
       return this.node;
     case 1 :
       this.signalGroupID = new j2375.dsrc.asncode.dsrc.SignalGroupID();
       return this.signalGroupID;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the SignalHeadLocation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the SignalHeadLocation.
  ...
  /**
   *  Creates and sets a newly allocated group value of the SignalHeadLocation.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
