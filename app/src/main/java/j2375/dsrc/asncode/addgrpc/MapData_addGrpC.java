...
/home/itsrc/J2375_2016/src/asncode/addgrpc/MapData_addGrpC.java: 
...
/**
 * Class definition of the MapData_addGrpC type of the addgrpc module.
 */
public class MapData_addGrpC extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 26;

  /**
   * optional field signalHeadLocations.
   */
  public j2375.dsrc.asncode.addgrpc.SignalHeadLocationList signalHeadLocations;

  /**
   *  Constructs a newly allocated MapData_addGrpC.
   */
  ...
  /**
   *  Gets the value of a component from this MapData_addGrpC.
  ...
  /**
   *  Creates a newly allocated component value from this MapData_addGrpC.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MapData_addGrpC.
  ...
  /**
   *  Creates and sets a newly allocated component value from this MapData_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this MapData_addGrpC.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.signalHeadLocations = new j2375.dsrc.asncode.addgrpc.SignalHeadLocationList();
       return this.signalHeadLocations;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the MapData_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the MapData_addGrpC.
  ...
  /**
   *  Creates and sets a newly allocated group value of the MapData_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
