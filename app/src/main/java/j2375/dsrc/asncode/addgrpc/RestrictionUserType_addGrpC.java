...
/home/itsrc/J2375_2016/src/asncode/addgrpc/RestrictionUserType_addGrpC.java: 
...
/**
 * Class definition of the RestrictionUserType_addGrpC type of the addgrpc module.
 */
public class RestrictionUserType_addGrpC extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 30;

  /**
   * optional field emission.
   */
  public j2375.dsrc.asncode.addgrpc.EmissionType emission;

  /**
   *  Constructs a newly allocated RestrictionUserType_addGrpC.
   */
  ...
  /**
   *  Gets the value of a component from this RestrictionUserType_addGrpC.
  ...
  /**
   *  Creates a newly allocated component value from this RestrictionUserType_addGrpC.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RestrictionUserType_addGrpC.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.addgrpc.EmissionType();
     default :
  ...
  /**
   *  Creates and sets a newly allocated component value from this RestrictionUserType_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this RestrictionUserType_addGrpC.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.emission = new j2375.dsrc.asncode.addgrpc.EmissionType();
       return this.emission;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
  ...
  /**
   *  Gets a group value from the RestrictionUserType_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the RestrictionUserType_addGrpC.
  ...
  /**
   *  Creates and sets a newly allocated group value of the RestrictionUserType_addGrpC.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
