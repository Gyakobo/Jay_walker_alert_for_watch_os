...
/home/itsrc/J2375_2016/src/asncode/addgrpc/VehicleToLanePosition.java: 
...
/**
 * Class definition of the VehicleToLanePosition type of the addgrpc module.
 */
public class VehicleToLanePosition extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 14;
  ...
  /**
   *  Constructs a newly allocated VehicleToLanePosition.
   */
  ...
  /**
   *  Gets the value of a component from this VehicleToLanePosition.
  ...
  /**
   *  Creates a newly allocated component value from this VehicleToLanePosition.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this VehicleToLanePosition.
  ...
  /**
   *  Creates and sets a newly allocated component value from this VehicleToLanePosition.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this VehicleToLanePosition.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the VehicleToLanePosition.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the VehicleToLanePosition.
  ...
  /**
   *  Creates and sets a newly allocated group value of the VehicleToLanePosition.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
