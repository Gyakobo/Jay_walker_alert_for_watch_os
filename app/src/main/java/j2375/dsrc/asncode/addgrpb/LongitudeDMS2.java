...
/home/itsrc/J2375_2016/src/asncode/addgrpb/LongitudeDMS2.java: 
 ...
 * <BR> total size of 4 octets (32 bits) when implicit encoding is used
 * Class definition of the LongitudeDMS2 type of the addgrpb module.
 */
public class LongitudeDMS2 extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 3;

  /**
   * mandatory field d.
   */
  public j2375.dsrc.asncode.addgrpb.DegreesLong d;
  ...
  /**
   *  Constructs a newly allocated LongitudeDMS2.
   */
  ...
  /**
   *  Gets the value of a component from this LongitudeDMS2.
  ...
  /**
   *  Creates a newly allocated component value from this LongitudeDMS2.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this LongitudeDMS2.
   ...
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       return new j2375.dsrc.asncode.addgrpb.DegreesLong();
     case 1 :
  ...
  /**
   *  Creates and sets a newly allocated component value from this LongitudeDMS2.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this LongitudeDMS2.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.d = new j2375.dsrc.asncode.addgrpb.DegreesLong();
       return this.d;
     case 1 :
