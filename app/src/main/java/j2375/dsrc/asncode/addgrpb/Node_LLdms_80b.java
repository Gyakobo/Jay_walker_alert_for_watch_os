...
/home/itsrc/J2375_2016/src/asncode/addgrpb/Node_LLdms_80b.java: 
...
/**
 * Class definition of the Node_LLdms_80b type of the addgrpb module.
 */
public class Node_LLdms_80b extends fr.marben.asnsdk.japi.spe.SequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 7;

  /**
   * mandatory field lon.
   */
  public j2375.dsrc.asncode.addgrpb.LongitudeDMS2 lon;

  /**
   * mandatory field lat.
   */
  public j2375.dsrc.asncode.addgrpb.LatitudeDMS2 lat;

  /**
   *  Constructs a newly allocated Node_LLdms_80b.
   */
  ...
  /**
   *  Gets the value of a component from this Node_LLdms_80b.
  ...
  /**
   *  Creates a newly allocated component value from this Node_LLdms_80b.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LLdms_80b.
  ...
  /**
   *  Creates and sets a newly allocated component value from this Node_LLdms_80b.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this Node_LLdms_80b.
   *  @return a value from a class implementing the IValue interface.
   */
                           ...
                           fr.marben.asnsdk.japi.vi.ISetSeqNamedType field)
   {
     ...
     {
     case 0 :
       this.lon = new j2375.dsrc.asncode.addgrpb.LongitudeDMS2();
       return this.lon;
     case 1 :
       this.lat = new j2375.dsrc.asncode.addgrpb.LatitudeDMS2();
       return this.lat;
     default :
       throw new fr.marben.asnsdk.japi.DysfunctionException("Unable to create field number " + field.getFieldNumber(context));
     }
