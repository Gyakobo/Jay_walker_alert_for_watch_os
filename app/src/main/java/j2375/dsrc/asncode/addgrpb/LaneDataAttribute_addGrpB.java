...
/home/itsrc/J2375_2016/src/asncode/addgrpb/LaneDataAttribute_addGrpB.java: 
...
/**
 * Class definition of the LaneDataAttribute_addGrpB type of the addgrpb module.
 */
public class LaneDataAttribute_addGrpB extends fr.marben.asnsdk.japi.spe.ExtSequenceValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 1;

  /**
   *  Constructs a newly allocated LaneDataAttribute_addGrpB.
   */
  ...
  /**
   *  Gets the value of a component from this LaneDataAttribute_addGrpB.
  ...
  /**
   *  Creates a newly allocated component value from this LaneDataAttribute_addGrpB.
   *  this value is created for temporary use to solve atNotations
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this LaneDataAttribute_addGrpB.
  ...
  /**
   *  Creates and sets a newly allocated component value from this LaneDataAttribute_addGrpB.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this LaneDataAttribute_addGrpB.
   *  @return a value from a class implementing the IValue interface.
  ...
  /**
   *  Gets a group value from the LaneDataAttribute_addGrpB.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
  ...
  /**
   *  Creates a newly allocated group value of the LaneDataAttribute_addGrpB.
  ...
  /**
   *  Creates and sets a newly allocated group value of the LaneDataAttribute_addGrpB.
   *  This method is only for ASNSDK internal use.
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param group the extension group.
   *  @param field the named type of the extension group.
