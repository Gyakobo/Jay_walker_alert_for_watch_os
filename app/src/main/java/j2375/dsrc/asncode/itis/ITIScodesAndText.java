...
/home/itsrc/J2375_2016/src/asncode/itis/ITIScodesAndText.java: 
...
/**
 * <BR> Classification of vehicles and types of transport
 * Class definition of the ITIScodesAndText type of the itis module.
 */
public class ITIScodesAndText extends fr.marben.asnsdk.japi.spe.SequenceOfValue
{
  /**
   * value of the typeIndex field for this class.
   */
  public static final int ASNTYPE = 221;
  ...
  public static class SEQUENCE extends fr.marben.asnsdk.japi.spe.SequenceValue
  {
    ...
    public static class Item extends fr.marben.asnsdk.japi.spe.ChoiceValue
    {
       ...
       * <BR>Use {@link j2375.dsrc.asncode.itis.ITIStext j2375.dsrc.asncode.itis.ITIStext} for the values of this type.
       */
       ...
       */
                            ...
                            throws fr.marben.asnsdk.japi.InvalidStructureException
       {
         ...
         case 0 :
           ...
           break;
         case 1 :
           this.value = (j2375.dsrc.asncode.itis.ITIStext)value;
           break;
         default :
       ...
       */
                               ...
                               fr.marben.asnsdk.japi.vi.IChoiceNamedType field)
       {
         ...
         case 0 :
           ...
           return this.value;
         case 1 :
           this.value = new j2375.dsrc.asncode.itis.ITIStext();
           return this.value;
         default :
  ...
  /**
   *  Constructs a newly allocated ITIScodesAndText.
   */
  ...
  /**
   *  Constructs a newly allocated ITIScodesAndText with the given list.
   *  @param list the list used to initialize this ITIScodesAndText.
   */
  public ITIScodesAndText (java.util.List list)
  {
    super(list);
  };
   ...
   *  this ITIScodesAndText.
   *  This method is only for ASNSDK internal use. 
   *  @param context a fr.marben.asnsdk.japi.Context.
   *  @param field the named type of this ITIScodesAndText.
  ...
  {
        j2375.dsrc.asncode.itis.ITIScodesAndText.SEQUENCE value = new j2375.dsrc.asncode.itis.ITIScodesAndText.SEQUENCE();
